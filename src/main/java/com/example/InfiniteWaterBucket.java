...
public class InfiniteWaterBucket extends Item {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        world.setBlockState(pos3, Blocks.WATER.getDefaultState().getFluidState().getBlockState());
        world.playSound(user, pos1, SoundEvents.ITEM_BUCKET_EMPTY, SoundCategory.BLOCKS, 1.0f, 1.0f);
